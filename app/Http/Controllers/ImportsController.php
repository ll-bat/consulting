...
class ImportsController extends Controller
{
      ...
      public function importProcess(Request $request){
           request()->validate([
               'process'   => 'required|mimes:csv,xls,xlsx'
           ]);
       
           $data = Excel::toArray(new ProcessesImport, request('process'));      
      ...
      public function importDanger(Request $request){
        request()->validate([
            'danger'   => 'required|mimes:csv,xls,xlsx'
        ]);
   ...
   public function importControl(Danger $danger){
        request()->validate([
