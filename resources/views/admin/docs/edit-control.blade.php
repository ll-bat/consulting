                   ...
                   @csrf
                             ...
                             <div class='d-flex'>
                                 ...
                                 <div class='mx-3 mt-3 text-left'>
                                       <input type='text' class='form-control border-0 autoresize'
                                              ...
                                              name='k'
                                              value = "{{$control->k}}"
                                              style='width:4rem;border-bottom:1px solid {{$color}} !important;border-radius:0' name='k' />
                                 </div>
                             </div>

                             <label class="ns-container text-secondary text-left ml-3 mt-2 mb-3" style='font-size:.95em; color:rgba(0,0,0,.8);'> ამცირებს პოტენციურ ზიანს
                                <input type="checkbox"
                                       name="rploss"
                                       value="1"
                      ...
                      <div class='card text-left border-0 partial-shadow'>
                           <div class='card-body ml-1 pb-4' required>
                                ...
                                <label class="ns-container mt-3 ml-3 text-secondary" style='font-size:.95em; color:rgba(0,0,0,.8);'>{{$danger->name}}
                                     <input type="checkbox"
                                            name="danger[]"
                                            value="{{ $danger->id }}"
                               ...
                               <div class='d-md-flex d-block'>
                                   ...
                                   <div class='text-left ml-md-2 ml-0'>
                                       <button class='btn my-del-btn' onclick="event.preventDefault();$1('control-delete').submit(); "> წაშლა </button>
                                   </div>
                               </div>
                            </div>
                      </div>
