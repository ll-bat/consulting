...
@section('content')
    ...
    <div class="mb-5 mx-4" style="width: 96% !important;;">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-9 col-md-10 col-sm-12 col-12 mr-4" id="main-part">
                ...
                <form method='post' action='docs/add-process'
                      class="text-left @if (!$errors->has('name')) d-none @endif" id='procarea'>
                    @csrf
                    <div class="border rounded bg-white mt-3 p-2" style='border-color:rgba(0,100,255, .3) !important'>
                        ...
                        @error('name')
                        <p class='text-danger text-sm text-left pl-2 mt-2 mb-0'
                           style='margin-top:-1rem;'> {{ $message }} </p>
                        @enderror
                    </div>
                ...
                <div class='card card-user mt-3 text-left rounded-10 shadow-none left-colored-border ns-border-bottom'
                    ...
                    <div class='pl-4 py-2'>
                        @foreach($procs as $ind => $proc)
                            <div class="row">
                                <div class="col-md-12 col-lg-11 col-xl-8 col-12">
                                    <p class="@if (Session('created') && $ind == $proc->count()-1) font-weight-bolder @else text-muted @endif"> {{$ind + 1}}
                                        . {{$proc->name}} </p>
                                </div>
                ...
                <div class='card mt-3 text-left rounded-10 shadow-none left-colored-border ns-border-bottom'>
                    ...
                    <div class="" v-if="plossLoading">
                        <div class="w-100 text-center" style="margin-top:50px; margin-bottom:70px">
                ...
                <div class='card mt-3 text-left rounded-10 shadow-none left-colored-border ns-border-bottom'
                    ...
                    <div class="" v-if="udangerLoading">
                        <div class="w-100 text-center" style="margin-top:50px; margin-bottom:70px">
                            <div class="spinner spinner-border" style="color: purple"></div>
                        </div>
                    </div>
                    ...
                    <div class='pl-4 pt-2 pb-3' id='udanger' v-if="!udangerLoading">
                        ...
                        <div class='d-flex'>
                            ...
                            <div class='position-absolute d-none' id="usaving-panel" style='right:.4rem;'>
                                ...
                                <div class='mx-1 my-1 mr-3 testit' v-else
                                     style='height:20px; width:20px;'>
                                    <i class='nc-icon nc-check-2 text-warning font-weight-bolder'
                                       style='color:purple !important;'></i>
                                </div>
                            </div>
                        </div>
                    </div>
