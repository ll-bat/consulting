           ...
           <table class='table-striped border w-100'>
              <thead>
                  <tr>
                     ...
                     <td rowspan='2'> {{ __("არსებული კონტროლის ზომები") }} </td>
                     <td colspan='3' class='text-danger'> {{ __("საწყისი რისკი") }} </td>
                     <td rowspan='2' class='smaller'> {{ __("გასატარებელ. ღონისძიებები. დამატებითი კონტროლის ზომები") }} </td>
                     <td colspan='3' class='text-success'> {{ __("ნარჩენი რისკი") }} </td>
